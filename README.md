...
Build low-latency live streaming apps with the Red5 Android SDK. Stream video using WebRTC, and subscribe (play) streams via WebRTC. Compatible with both [Red5 Cloud](https://www.red5.net/red5-cloud-low-latency-live-streaming-platform/) (Stream Manager) and standalone [Red5pro](https://www.red5.net/red5-pro/low-latency-streaming-software/) servers.
