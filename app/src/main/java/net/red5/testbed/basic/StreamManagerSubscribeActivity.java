...
public class StreamManagerSubscribeActivity extends AppCompatActivity implements IRed5WebrtcClient.Red5ProWebrtcEventListener {
    private static final String TAG = "StreamManagerSubscribeActivity";
